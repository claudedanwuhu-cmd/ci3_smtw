...
$message_html = isset($message) ? $message : 'Terjadi kesalahan pada database.';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        ...
        .box { margin-top: 18px; padding: 14px 16px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; line-height: 1.7; }
    </style>
</head>
<body>
    <div class="wrap">
