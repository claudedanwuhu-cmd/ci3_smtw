...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header-custom mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="page-subtitle">Perbarui informasi data pendidik atau staff di bawah ini.</p>
                </div>
            </div>
        ...
        <!-- FORM INPUT EDIT -->
        <form id="form-edit-guru" action="<?= site_url('admin/guru/update/' . $guru->id); ?>" method="POST" enctype="multipart/form-data">
            <div class="custom-card mb-4">
                ...
                <div class="card-body-custom">
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="gender-selector">
                                <label class="gender-option">
                                    <input type="radio" name="jenis_kelamin" value="L" <?= (isset($guru->jenis_kelamin) && $guru->jenis_kelamin == 'L') ? 'checked' : ''; ?>>
                                ...
                                <label class="gender-option">
                                    <input type="radio" name="jenis_kelamin" value="P" <?= (isset($guru->jenis_kelamin) && $guru->jenis_kelamin == 'P') ? 'checked' : ''; ?>>
                                    <div class="gender-box">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="jabatan" class="form-control with-icon"
                                    value="<?= html_escape($guru->jabatan ?? ''); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="mata_pelajaran" class="form-control with-icon"
                                    value="<?= html_escape($guru->mata_pelajaran ?? ''); ?>"
                        ...
                        <div class="col-md-12">
                            <label class="form-label">Upload Foto / Avatar Guru <small class="text-muted fw-normal">(Biarkan kosong jika tidak ingin mengganti)</small></label>
                            <div class="upload-dropzone" onclick="document.getElementById('fotoInput').click();">
                                ...
                                <!-- Hidden input simpan nama foto lama jika ada -->
                                <input type="hidden" name="foto_lama" value="<?= html_escape($guru->foto ?? ''); ?>">

                                <div class="upload-content text-center <?= (!empty($guru->foto)) ? 'd-none' : ''; ?>" id="uploadPlaceholder">
                                ...
                                <?php 
                                    // Logika penentuan URL foto lama
                                    $foto_src = '#';
                                    if (!empty($guru->foto)) {
                                        // Cek apakah string foto sudah mengandung folder 'uploads/' atau belum
                                        if (strpos($guru->foto, 'uploads/') !== false || strpos($guru->foto, 'assets/') !== false) {
                                            $foto_src = base_url($guru->foto);
                                        } else {
                                            $foto_src = base_url('assets/img/' . ltrim($guru->foto, '/'));
                                    }
                                    }
                                ?>

                                <div class="preview-container <?= (empty($guru->foto)) ? 'd-none' : ''; ?> text-center" id="previewWrapper">
                                    <img id="imgPreview" 
                                         src="<?= $foto_src; ?>" 
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="deskripsi" class="form-control custom-textarea" rows="4"
                                placeholder="Tuliskan latar belakang singkat, prestasi, atau kata pengantar guru..."><?= html_escape($guru->deskripsi ?? ''); ?></textarea>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" class="form-select custom-select">
                                <option value="aktif" <?= (isset($guru->status) && $guru->status == 'aktif') ? 'selected' : ''; ?>>🟢 Aktif Mengajar</option>
                                <option value="nonaktif" <?= (isset($guru->status) && $guru->status == 'nonaktif') ? 'selected' : ''; ?>>🔴 Nonaktif / Cuti</option>
                            </select>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var formEdit = document.getElementById('form-edit-guru');
