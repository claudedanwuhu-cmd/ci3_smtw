<?php
/**
 * Halaman edit pengguna (form mandiri, tanpa partial).
 * Variabel: $user (object)
 */
$is_edit      = true;
$u            = (isset($user) && is_object($user)) ? $user : null;
$action       = site_url('admin/user/update/' . rawurlencode($u !== null && isset($u->id) ? (string) $u->id : ''));
        ...
        <div class="page-header-custom mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="page-subtitle">Perbarui data akun, hak akses, dan status user.</p>
                </div>
            </div>
        ...
        <div class="custom-card">
            <div class="card-title-custom">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5>Formulir Edit User</h5>
                        <small>Sesuaikan data akun atau hak akses di bawah ini</small>
                    </div>
                </div>
                <span class="total-badge"><i class="fa-solid fa-pen-to-square me-1"></i> Form Edit</span>
            </div>
