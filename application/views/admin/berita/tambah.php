        ...
        <div class="page-header-custom mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="page-subtitle">Tambahkan publikasi berita baru untuk sekolah.</p>
                </div>
            </div>
        ...
        <div class="custom-card mb-4">
            ...
            <div class="card-title-custom">
                ...
                <div>
                    ...
                    <small>Lengkapi informasi publikasi berita</small>
                </div>
            </div>

            <div class="card-body-custom">
                <form action="<?= site_url('admin/berita/simpan'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="judul" class="form-control with-icon" placeholder="Masukkan judul berita" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="date" name="tanggal" class="form-control with-icon" value="<?= date('Y-m-d'); ?>">
                            </div>
                        </div>
                            ...
                            <div class="upload-dropzone" id="berita-thumbnail-upload" role="button" tabindex="0" aria-label="Pilih thumbnail berita">
                                ...
                                <div class="preview-container d-none text-center" id="previewWrapper">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2">
                                        <span class="preview-filename text-truncate d-inline-block" style="max-width: 250px;" id="previewFilename">thumbnail.jpg</span>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-icon-group">
                                ...
                                <textarea name="isi" class="form-control custom-textarea with-icon" rows="6" placeholder="Tuliskan isi berita di sini..."></textarea>
                            </div>
                        </div>
