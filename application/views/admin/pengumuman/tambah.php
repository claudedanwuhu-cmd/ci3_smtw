...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header-custom mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="page-subtitle">Buat pengumuman baru untuk ditampilkan di website sekolah.</p>
                </div>
            </div>
        ...
        <!-- FORM INPUT -->
        <form id="form-tambah-pengumuman" action="<?= site_url('admin/pengumuman/simpan'); ?>" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="date" name="tanggal" class="form-control with-icon peng-date-input" value="<?= date('Y-m-d'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="isi" id="peng-isi" class="form-control custom-textarea" rows="7"
                                placeholder="Tuliskan isi lengkap pengumuman di sini..."></textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="status-toggle-card" id="status-toggle" role="switch" tabindex="0" aria-checked="true">
                                <div class="status-toggle-icon">
                                    <i class="fa-solid fa-circle-check"></i>
                                </div>
                                <div class="status-toggle-text">
                                    <span class="status-toggle-label">Aktif Ditampilkan</span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var formTambah = document.getElementById('form-tambah-pengumuman');
