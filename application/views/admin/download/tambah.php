    ...
    <div class="content-wrapper">
        ...
        <div class="page-header-custom mb-4">
            <div class="page-header-left">
                <div class="page-header-icon"><i class="fa-solid fa-file-circle-plus"></i></div>
                <div>
                    <span class="badge-header-tag"><i class="fa-solid fa-plus"></i> Form Input</span>
                    <h2 class="page-title">Tambah File Download</h2>
                    <p class="page-subtitle">Tambahkan dokumen baru yang dapat diunduh pengunjung.</p>
                </div>
            </div>
        ...
        <div class="custom-card">
            <div class="card-title-custom">
                ...
                <div>
                    <h5>Data File Download</h5>
                    <small>Isi informasi dokumen yang akan dipublikasikan.</small>
                </div>
            </div>

            <form action="<?= site_url('admin/download/simpan'); ?>" method="post" enctype="multipart/form-data" data-download-form>
                    ...
                    <div class="row g-4">
                        <div class="col-md-8">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="judul" class="form-control with-icon" placeholder="Masukkan judul file" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-icon-group">
                                ...
                                <select name="kategori" class="form-select with-icon">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="download-upload-box" id="download-upload-box" role="button" tabindex="0" aria-label="Pilih file untuk diunggah">
                                <input type="file" name="file" id="download-file-input" class="file-input-hidden" accept=".pdf,.doc,.docx,.xls,.xlsx,.zip" required>
                                <div class="upload-content">
                                    <div class="upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
                                    <div>
                                        <strong id="download-upload-label">Klik atau seret file ke sini</strong>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="date" name="tanggal" class="form-control with-icon" value="<?= html_escape(date('Y-m-d')); ?>">
                            </div>
                        </div>

                        <div class="col-12">
                            <label class="form-label">Keterangan</label>
                            <textarea name="keterangan" rows="6" maxlength="1000" class="form-control custom-textarea" placeholder="Masukkan keterangan file..." data-char-counter></textarea>
                ...
                <div class="form-footer">
                    ...
                    <button type="submit" class="btn-save">
                        <span class="btn-save-content"><i class="fa-solid fa-floppy-disk me-2"></i>Simpan File</span>
